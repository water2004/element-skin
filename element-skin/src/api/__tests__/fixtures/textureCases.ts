...
export function textureApiCases(context: ApiCaseContext): ApiCase[] {
  return [
    ...
    },
    {
      ...
      args: ['/v2/users/me/textures', context.textureForm],
    },
    {
      name: 'getTextureDetail gets hash/type detail',
      method: 'get',
      call: () => getTextureDetail('hash-1', 'skin'),
      args: ['/v2/users/me/textures/hash-1/skin'],
    },
    {
      ...
      args: [
        '/v2/users/me/textures/hash-1/skin',
    ...
    },
    {
      ...
      args: ['/v2/users/me/textures/hash-public/cape', { is_public: false }],
    },
    {
      name: 'deleteTexture deletes texture identity',
      method: 'delete',
      call: () => deleteTexture('hash-1', 'cape'),
      args: ['/v2/users/me/textures/hash-1/cape'],
    },
    {
      name: 'addToWardrobe posts null body with texture_type param',
      method: 'post',
      call: () => addToWardrobe('hash-1', 'skin'),
      args: ['/v2/users/me/textures/hash-1/wardrobe', null, { params: { texture_type: 'skin' } }],
    },
    {
